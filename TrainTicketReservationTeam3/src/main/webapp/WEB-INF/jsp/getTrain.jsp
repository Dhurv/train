...
<nav class="navbar navbar-expand-md navbar-dark bg-dark ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-1 mx-2" type="submit">
          <a href="/accounts/logout">Logout</a>
      </button>

      <button type="button" class="btn btn-outline-warning my-2 my-sm-0 mx-2" >
...
<div class="container-fluid">
    ...
    <% Train tList = (Train) request.getAttribute("");%>
        <table class="table table-striped table-dark">
            ...
            <% for(Train t:tList) {%>
            <tr>
                <th scope="row"><% out.print(t.getTrain_no()); %></th>
